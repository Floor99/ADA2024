...
if __name__ == '__main__':
    ...
    create_subscription("project-lab-1-399708", "diabetes_res", "diabetes_res_sub")
    pull_message(project="project-lab-1-399708", subscription="diabetes_res_sub")  # replace ada2023 with your project id
